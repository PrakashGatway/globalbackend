...
const STUDY_ABROAD_JOURNEY_STEPS = [
    ...
    {
        id: 2,
        label: 'Country Shortlisted',
        key: 'country_shortlisted',
        description: 'Select preferred study destinations',
    ...
    },
    {
        ...
        label: 'Offer Letter',
        key: 'offer_letter',
        description: 'Receive offer letter from university',
        route: '/dashboard/application',
        icon: 'award',
    ...
    },
    {
        ...
        label: 'Visa Process',
        key: 'visa_process',
        description: 'Apply and complete visa process',
    ...
    },
    {
        ...
        label: 'Forex & Finance',
        key: 'forex_finance',
        description: 'Manage forex and financial arrangements',
    ...
    },
    {
        ...
        label: 'Pre-Departure',
        key: 'pre_departure',
        description: 'Prepare for your departure',
        // route: '/pre-departure',
        icon: 'plane',
